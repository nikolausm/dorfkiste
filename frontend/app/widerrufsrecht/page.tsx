    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-gray-900">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 lg:p-12 shadow-soft space-y-8">

            {/* Important Notice */}
            <div className="bg-accent-50 dark:bg-accent-900/20 border-l-4 border-accent-500 dark:border-accent-600 p-6 rounded-r-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-neutral-900 dark:text-gray-100 mb-2">Wichtiger Hinweis</h3>
            ...
            {/* Widerrufsbelehrung */}
            <div>
              <h2 className="text-2xl font-bold text-neutral-900 dark:text-gray-100 mb-4">Widerrufsbelehrung</h2>
              <div className="prose prose-neutral dark:prose-invert max-w-none">
                <h3 className="text-lg font-semibold text-neutral-900 dark:text-gray-100 mt-6 mb-3">Widerrufsrecht</h3>
                ...
                <h3 className="text-lg font-semibold text-neutral-900 dark:text-gray-100 mt-6 mb-3">Folgen des Widerrufs</h3>
                <p className="text-neutral-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            {/* Ausnahmen */}
            <div className="bg-neutral-50 dark:bg-gray-900/50 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-gray-100 mb-3">Ausnahmen vom Widerrufsrecht</h3>
              <p className="text-neutral-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            {/* Widerrufsformular */}
            <div>
              <h2 className="text-2xl font-bold text-neutral-900 dark:text-gray-100 mb-4">Muster-Widerrufsformular</h2>
              <div className="bg-white dark:bg-gray-900/50 border-2 border-neutral-200 dark:border-gray-700 rounded-xl p-6">
                <p className="text-sm text-neutral-500 dark:text-gray-400 mb-4">
                  (Wenn Sie den Vertrag widerrufen wollen, füllen Sie bitte dieses Formular aus und senden Sie es zurück)
                </p>

                <div className="space-y-4 text-neutral-700 dark:text-gray-300">
                  <p>An:</p>
                  <div className="pl-4">
                    <p>Dorfkiste</p>
                    <p>Musterstraße 1</p>
            ...
            <div className="bg-primary-50 dark:bg-primary-900/20 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-gray-100 mb-3 flex items-center gap-2">
            ...
            {/* Kontakt */}
            <div className="border-t border-neutral-200 dark:border-gray-700 pt-8">
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-gray-100 mb-4">Kontakt bei Fragen</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-neutral-900 dark:text-gray-100">E-Mail</p>
                    <a href="mailto:widerruf@dorfkiste.de" className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-neutral-900 dark:text-gray-100">Telefon</p>
                    <a href="tel:+491234567890" className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300">
                      +49 123 456 7890
                    </a>
                  </div>
                </div>
