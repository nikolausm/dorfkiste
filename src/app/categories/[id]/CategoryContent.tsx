...
export default function CategoryContent({ categoryId, categoryName, categoryDescription }: Props) {
      ...
      <nav className="text-sm mb-4">
        <ol className="flex items-center space-x-2 text-gray-600">
          ...
          <li className="before:content-['>'] before:mx-2">
            <a href="/categories" className="hover:text-blue-600">Kategorien</a>
          </li>
          <li className="before:content-['>'] before:mx-2">
        ...
        <div className="flex-1">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 mb-4">
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-600">
                {resultsCount > 0 && (
                  <span>{resultsCount} Artikel in dieser Kategorie</span>
                )}
              </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12 bg-white rounded-lg">
              <p className="text-gray-500">Keine Artikel in dieser Kategorie</p>
              <p className="text-sm text-gray-400 mt-2">Sei der Erste und stelle einen Artikel ein!</p>
            </div>
          ) : (
            <>
